...
public class CategoryController {
	...
	public ResponseEntity<?> registerReminder(@RequestBody Category category) {
		try {
	...
	public ResponseEntity<?> updateCategoy(@PathVariable("id") String id) {
		try {
			Category cat = categoryService.getCategoryById(id);
			Category cat2 = categoryService.updateCategory(cat, id);
			if (cat == cat2)
