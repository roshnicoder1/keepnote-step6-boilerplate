...
public class ReminderController {
	...
	public ResponseEntity<?> registerReminder(@RequestBody Reminder reminder) {
		try {
	...
	public ResponseEntity<?> getReminder(@RequestBody List<Reminder> reminderList) throws ReminderNotFoundException {
